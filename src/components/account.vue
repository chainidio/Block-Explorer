    ...
    <el-container>
        ...
        <el-main >
            <el-breadcrumb class="center" separator-class="el-icon-arrow-right">
                ...
                <el-breadcrumb-item>账号Address</el-breadcrumb-item>
            </el-breadcrumb>
                ...
                <el-collapse v-model="activeNames" @change="handleChange">
                    <el-collapse-item v-if="accounts.currentLesseeRS" title="出租信息" name="1">
                        <el-form :inline="true" class="demo-form-inline">
                            ...
                            <el-form-item style="margin-bottom: 0" label="承租人账号Address">
                        ...
                        <el-form v-show="accounts.nextLessee" :inline="true" class="demo-form-inline">
                            ...
                            <el-form-item style="margin-bottom: 0" label="下一个承租人账号Address">
        ...
        <el-footer class="footer">
            ...
            <a target="_blank" href="https://chainid.io/">CHAIN PLATFORM</a>
        </el-footer>
    </el-container>
</template>
